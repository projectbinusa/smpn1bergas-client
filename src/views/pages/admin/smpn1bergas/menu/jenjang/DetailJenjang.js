  ...
  const deleteData = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${API_DUMMY}/api/jenjang/` + id, {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
          })
          ...
          <div className="box-tabel">
            <div className="card shadow w-100">
              ...
              <div className="card-body">
                <div className="mb-3">
                  <label className="form-label fw-bold">Nama Jenjang</label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label className="form-label fw-bold">Deskripsi Jenjang</label>
                  <div
                    className="form-control"
