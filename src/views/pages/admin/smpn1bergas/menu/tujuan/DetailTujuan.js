  ...
  const getAll = async () => {
    try {
      const response = await axios.get(
        `${API_DUMMY}/api/tujuan/all/terbaru?page=0&size=1`,
        {
          headers: {
          ...
          <div className="box-tabel">
            <div className="card shadow w-100">
              <div className="title card-header d-flex justify-content-between">
                <h1 className="fw-bold fs-3">Tujuan Sekolah</h1>
                {datas.length > 0 ? (<>
                  <div>
                    <button
                      type="button"
              ...
              <div className="card-body">
                <div class="mb-3">
                  <label class="form-label fw-bold">Judul Tujuan</label>
                  <input
                    type="text"
                    class="form-control"
                    disabled
                ...
                <div class="mb-3">
                  <label class="form-label fw-bold">Isi Tujuan</label>
                  <div
