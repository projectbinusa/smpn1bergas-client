...
function AdminDetailLaporanBosp() {
      ...
      <div style={{ marginTop: "10px" }} className="page-content1 mt-3 mb-3 app-main__outer">
        <div className="container box-tabel">
          <form className="card shadow w-100">
            <h1 className="title card-header fw-bold fs-3">Detail Laporan BOSP</h1>
            <br />
            <div className="card-body">
              <div class="mb-3">
                <label class="form-label fw-bold">Nama Laporan BOSP</label>
                <input
                  type="text"
                  class="form-control"
                  disabled
  ...
  >
    {datas.files.map((imageUrl, index) => (
      <div key={index}>
        <img
          src={imageUrl}
          alt={`laporanbosp ${index}`}
          style={{
            display: "block",
            maxWidth: "70%",
            height: "auto"
...
export default AdminDetailLaporanBosp;
